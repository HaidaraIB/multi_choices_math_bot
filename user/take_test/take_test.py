...
import models
from user.take_test.common import build_test_options_keyboard, finish_test
    ...
    if update.effective_chat.type == Chat.PRIVATE:
        ...
        await update.callback_query.edit_message_text(
            text=(
                ...
                "مدة الاختبار {} دقيقة، {} دقيقة لكل سؤال.\n"
                "عدد الأسئلة {} سؤال.\n"
                "ستظهر الأسئلة واحداً تلو الآخر.\n"
                "لا يمكنك تغيير الإجابة بعد اختيارها.\n"
                "سيتم احتساب العلامة النهائية من {} بعد نهاية الاختبار على الفور.\n\n"
